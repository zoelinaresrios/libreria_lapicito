...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-09-2025 a las 22:51:46
...
INSERT INTO `inventario` (`id_inventario`, `id_sucursal`, `id_producto`, `stock_actual`, `stock_minimo`) VALUES
(1, 2, 24, 40, 19),
(2, 1, 25, 60, 8),
(3, 2, 26, 20, 78);
...
(1, 26, 'ingreso', 20, 'compra', 0, 20, 0, '2025-09-03 02:18:18');
...
INSERT INTO `movimiento` (`id_movimiento`, `fecha_hora`, `id_tipo_movimiento`, `id_sucursal_origen`, `id_sucursal_destino`, `id_usuario`, `observacion`) VALUES
(1, '2025-08-25 20:15:34', 1, NULL, 2, 2, 'Carga inicial de inventario (seed)');
...
INSERT INTO `producto` (`id_producto`, `codigo`, `nombre`, `id_subcategoria`, `id_proveedor`, `ubicacion`, `precio_compra`, `precio_venta`, `activo`, `creado_en`, `actualizado_en`) VALUES
(24, '67934', 'lapicera bic azul', 2, 1, 'a56', 1000.00, 1600.00, 1, '2025-08-27 18:58:26', '2025-08-27 18:58:26'),
(25, '435', 'lapiz', 2, 1, 'jj87', 378.00, 978.00, 1, '2025-09-03 01:01:55', '2025-09-03 01:01:55'),
(26, '777', 'goma', 2, 1, 'gg89', 78.00, 200.00, 1, '2025-09-03 01:02:36', '2025-09-03 01:02:36');
...
INSERT INTO `proveedor` (`id_proveedor`, `nombre`, `contacto`, `telefono`, `email`, `cuit`, `rubro`, `condiciones`) VALUES
(1, 'provedoe1', '423rferg34', '11876654', '123zoe@gmail.com', '655555-8', 'pepelersa', NULL);
...
(2, 'Central', 'Av. Principal 123', '000-000', '2025-08-25 20:15:34');
...
(3, 'Zoe', 'linaresrioszoe@gmail.com', '', '$2y$10$CqsXDSp59VvJ4INbjVpDC.kEHjV4Cu.3EI6gYV39jtKUZSzQzWDHy', 1, 1, '2025-09-03 17:51:20', '2025-09-03 17:51:20');
...
--
ALTER TABLE `inventario`
  MODIFY `id_inventario` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
